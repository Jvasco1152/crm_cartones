...
export const CIUDADES = [
  ...
  'Santa Marta', 'Villavicencio', 'Pasto', 'Montería', 'Armenia',
]

export const SEGMENTOS = [
  'Alimentos', 'Bebidas', 'Flores', 'Farmacéutico', 'Industrial',
  'Retail', 'Textil', 'Construcción', 'Tecnología', 'Logística', 'Otro',
]

export const ESTADOS_CLIENTE = ['Activo', 'Inactivo', 'Prospecto', 'En Negociación']
